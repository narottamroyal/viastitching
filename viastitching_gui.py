...
class viastitching_gui ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		fgOptionsSizer.Add( self.m_cbNet, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL|wx.EXPAND, 5 )
		...
		fgOptionsSizer.Add( self.m_lblPattern, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT|wx.ALL, 5 )
		...
		fgOptionsSizer.Add( self.m_cbPattern, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL|wx.EXPAND, 5 )
		...
		fgOptionsSizer.Add( bHSizer1, 0, wx.EXPAND, 5 )
		...
		fgOptionsSizer.Add( self.m_lblOffset, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT|wx.ALL, 5 )
		...
		bHSizer3.Add( self.m_lblUnit3, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )
		...
		bHSizer4.Add( self.m_txtEdgeClearance, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )
		...
		bHSizer4.Add( self.m_lblUnit4, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )


		fgOptionsSizer.Add( bHSizer4, 1, wx.EXPAND, 5 )


		bMainSizer.Add( fgOptionsSizer, 0, wx.EXPAND|wx.ALL, 5 )
		...
		self.m_chkRemoveAll = wx.CheckBox( self, wx.ID_ANY, _(u"Remove all vias"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_chkRemoveAll.Enable( False )

		bHSizer5.Add( self.m_chkRemoveAll, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )
		...
		bMainSizer.Add( bHSizer6, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )
